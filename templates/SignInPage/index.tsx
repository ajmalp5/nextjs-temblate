...
const SignInPage = () => {
    return (
        <div className="min-h-screen-ios lg:p-6 md:px-6 md:pt-16 md:pb-10 relative flex min-h-screen">
            <div className="relative shrink-0 w-[40rem] p-20 overflow-hidden 2xl:w-[37.5rem] xl:w-[30rem] xl:p-10 lg:hidden">
                <div className="max-w-[25.4rem]">
                    <div className="h2 text-n-1 mb-4">
            ...
            <Link
                className="group top-12 right-12 bg-n-2 text-0 hover:bg-primary-1 md:top-6 md:right-6 absolute flex items-center justify-center w-10 h-10 transition-colors rounded-full"
                href="/"
            >
                <Icon
                    className="fill-n-7 group-hover:fill-n-1 transition-colors"
                    name="close"
                />
            </Link>
        </div>
