					...
					>
						...
						>
							...
							{hideRightSidebar && smallSidebar && (
								<Link
									className="top-6 right-6 border-n-4/25 text-0 hover:border-transparent hover:bg-n-4/25 absolute flex items-center justify-center w-10 h-10 transition-colors border-2 rounded-full"
									href={backUrl || '/'}
								>
